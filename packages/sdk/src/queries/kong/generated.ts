...
export type kong_SplitterLogsQueryVariables = Exact<{
  chainId?: InputMaybe<Scalars['Int']['input']>
}>

export type kong_SplitterLogsQuery = {
  newYieldSplitterLogs?: Array<{
    chainId: number
    address: string
    splitter: string
    vault: string
...
export const SplitterLogsDocument = /*#__PURE__*/ gql`
    query SplitterLogs($chainId: Int) {
  newYieldSplitterLogs(chainId: $chainId) {
    chainId
    address
    splitter
    vault
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    SplitterLogs(
      variables?: kong_SplitterLogsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<kong_SplitterLogsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<kong_SplitterLogsQuery>(SplitterLogsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'SplitterLogs',
